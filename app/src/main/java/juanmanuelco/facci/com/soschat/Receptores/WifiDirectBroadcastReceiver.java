...
import juanmanuelco.facci.com.soschat.Entidades.Mac;
					...
					mManager.requestConnectionInfo(mChannel, new ConnectionInfoListener() {
						...
						public void onConnectionInfoAvailable(WifiP2pInfo info) {
							...
							if (info.groupFormed && info.isGroupOwner) {
								...
								client.Destino(mac.getMac());
								client.start();
								Toast.makeText(context,"cliente mac:" + DireccionMAC.MacOnclick, Toast.LENGTH_LONG).show();
							}
